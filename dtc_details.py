...
class d_tree_info(QtGui.QWidget):
    def __init__(self):
    ...
    def UI(self):
        ...
        self.label0 = QtGui.QLabel('DECISION TREE CLASSIFIER')
        self.label0.setFont(QtGui.QFont('Calibri', 12, QtGui.QFont.Bold))
        self.label = QtGui.QLabel('1) (MIN_SAMPLES_SPLIT = 20)- requires 20 SAMPLES in a node \n for it to be split\n')
        self.label.setFont(QtGui.QFont('Calibri',10))
        self.label1 = QtGui.QLabel('2) (RANDOM_STATE = 99) - is to SEED the random NUMBER generator\n')
        self.label.setFont(QtGui.QFont('Calibri',10))
        self.label2 = QtGui.QLabel('3) VALUE = [50.0. 0.] - if a cond is TRUE, take the left/right branch to get to the 50 SAMPLES. \n\n'
        ...
        self.label3 = QtGui.QLabel('INDICES:\n\t'
                                   '        P.FALCIPARUM -> [0]\n\t'
                                   '        P. VIVAX -> [1]\n\t'
                                   '        P.MALARAE -> [2]\n\t'
                                   '        P.OVALE -> [3]\n\t')
        self.label3.setFont(QtGui.QFont('Calibri',10))
